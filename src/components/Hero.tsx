          ...
          >
            ...
            >
              ...
              <div
                ...
                className="bg-white border border-zinc-200 rounded-2xl shadow-xl overflow-hidden"
              >
                {/* Browser chrome */}
                ...
                <div className="p-4">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-lg font-black text-black">$124,800</p>
                    </div>
              ...
              >
                <p className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest mb-3">AI Pipeline</p>
                <div className="space-y-2">
                  {[
                    { label: "Ingest data", done: true },
                    { label: "Process & embed", done: true },
                    { label: "Deploy model", done: false },
                  ].map((step) => (
                    <div key={step.label} className="flex items-center gap-2">
                      <div className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${step.done ? "bg-[#FF751F]" : "bg-zinc-200"}`} />
                      <span className={`text-[10px] font-medium ${step.done ? "text-zinc-700" : "text-zinc-300"}`}>{step.label}</span>
                      {step.done && <span className="ml-auto text-[9px] text-emerald-500 font-bold">✓</span>}
                    </div>
                  ))}
                </div>
              </div>
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-[#FF751F] flex items-center justify-center flex-shrink-0">
              ...
              >
                <p className="text-2xl font-black text-white tabular-nums">98ms</p>
